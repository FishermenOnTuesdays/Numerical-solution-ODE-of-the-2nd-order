...
public:
	...
	SecondOrderODESolver(std::vector<FunctionParser> functions_coefficients, Eigen::Matrix<double, 2, 3> boundary_coefficients, std::pair<double, double> border, size_t N);
